...
////@begin FindInFilesDlg content construction
    ...
    itemBoxSizer7->Add(itemStaticText8, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 7);//|wxADJUST_MINSIZE
    ...
    itemBoxSizer11->Add(itemStaticText12, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 7);//|wxADJUST_MINSIZE
