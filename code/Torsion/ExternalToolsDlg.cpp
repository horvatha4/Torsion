...
////@begin ExternalToolsDlg content construction
   ...
   itemBoxSizer4->Add(itemStaticText5, 0, wxALIGN_TOP|wxLEFT|wxTOP|wxBOTTOM, 0);//|wxADJUST_MINSIZE
   ...
   itemBoxSizer17->Add(itemStaticText18, 0, wxALIGN_CENTER_VERTICAL, 5);//|wxADJUST_MINSIZE
   ...
   itemBoxSizer20->Add(itemStaticText21, 0, wxALIGN_CENTER_VERTICAL, 5);//|wxADJUST_MINSIZE
   ...
   itemBoxSizer24->Add(itemStaticText25, 0, wxALIGN_CENTER_VERTICAL, 5);//|wxADJUST_MINSIZE
   ...
   itemBoxSizer28->Add(itemStaticText29, 0, wxALIGN_CENTER_VERTICAL, 5);//|wxADJUST_MINSIZE
