...
////@begin BreakpointPropertyDlg content construction
    ...
    itemBoxSizer5->Add(itemStaticText6, 0, wxALIGN_CENTER_VERTICAL|wxALL, 0);//|wxADJUST_MINSIZE
    ...
    itemBoxSizer9->Add(itemStaticText10, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 0);//|wxADJUST_MINSIZE
